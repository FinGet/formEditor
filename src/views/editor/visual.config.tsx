...
visualConf.registryCategory([
  {key: 'base', label: '基础题目'},
  {key: 'page', label: '分页说明'},
  {key: 'validate', label: '信息校验'}
]);

visualConf.registry('text','base', {
  label: '文本',
...
visualConf.registry('button', 'base', {
  label: '按钮',
...
visualConf.registry('input', 'base', {
  label: '输入框',
...
visualConf.registry('select','page', {
  label: '选择框',
  preview: () => <ElSelect />,
...
visualConf.registry('number-range','page', {
  label: '数字范围',
...
visualConf.registry('image', 'validate', {
  label: '图片',
  resize: {
    width: true,
    height: true,
